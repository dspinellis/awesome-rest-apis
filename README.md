...
## General
- [CalcFi Insights](https://calcfi.app/developers) - Free REST API exposing personal-finance calculator aggregates (k-anonymity ≥ 10) and primary-source macro data feeds (FRED, BLS, IRS, Treasury, Freddie Mac); [example](https://calcfi.app/api/insights/openapi.json). No auth, HTTPS, CORS, CC BY 4.0.
